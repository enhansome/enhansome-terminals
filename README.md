...
* [ish](https://github.com/tbodt/ish) ⭐ 20,508 | 🐛 645 | 🌐 C | 📅 2026-09-20 - Linux shell for iOS. <https://ish.app>
...
* [Tabby](https://github.com/Eugeny/tabby) ⭐ 74,663 | 🐛 2,847 | 🌐 TypeScript | 📅 2026-09-24 - A terminal for a more modern age (formerly Terminus) <https://tabby.sh/>
...
* [Kitty](https://github.com/kovidgoyal/kitty) ⭐ 35,054 | 🐛 17 | 🌐 Python | 📅 2026-09-24 - A cross-platform, fast, feature full, GPU based terminal emulator
* [Wezterm](https://github.com/wez/wezterm) ⭐ 29,011 | 🐛 1,876 | 🌐 Rust | 📅 2026-09-21 - A GPU-accelerated cross-platform terminal emulator and multiplexer written by @wez and implemented in Rust. <https://wezfurlong.org/wezterm/>
* [Upterm](https://github.com/railsware/upterm) ⚠️ Archived - **\[DEPRECATED]** A terminal emulator for the 21st century.
* [electerm](https://github.com/electerm/electerm) ⭐ 15,187 | 🐛 341 | 🌐 JavaScript | 📅 2026-09-24 - Terminal / ssh / sftp / ftp / telnet / serialport / RDP / VNC / Spice client(linux, mac, win). <https://electerm.org/>
* [Mosh](https://github.com/mobile-shell/mosh) ⭐ 14,510 | 🐛 230 | 🌐 C++ | 📅 2026-03-22 - Mobile Shell.
...
* [tty7](https://github.com/l0ng-ai/tty7) ⭐ 1,077 | 🐛 36 | 🌐 Rust | 📅 2026-09-24 - A GPU-rendered, daemon-backed terminal in pure Rust; a persistent daemon holds the PTYs so sessions survive quitting the app (no tmux). Built on Zed's gpui and Alacritty's VT core.
* [QTerminal](https://github.com/lxqt/qterminal) ⭐ 716 | 🐛 85 | 🌐 C++ | 📅 2026-09-22 - A lightweight Qt-based terminal emulator.
...
* [Gnome Terminal](https://github.com/GNOME/gnome-terminal) ⭐ 327 | 🐛 0 | 🌐 C++ | 📅 2026-09-23 - A terminal emulator for GNOME.
...
* [OdyTTY](https://github.com/ghreprimand/odytty) ⭐ 35 | 🐛 0 | 🌐 Rust | 📅 2026-09-24 - A GPU-rendered terminal emulator for Linux (Rust/wgpu) with a theme builder, 100 themes, bloom/CRT/retro effects, and live in-app config. <https://odytty.unfinished-works.com/>
...
* [Sinclair](https://github.com/wess/sinclair) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-09-16 - A GPU-accelerated terminal emulator with tabs, splits, themes, kitty keyboard protocol, and shell integration. <https://wess.io/sinclair/>
...
* [Kitty](https://github.com/kovidgoyal/kitty) ⭐ 35,054 | 🐛 17 | 🌐 Python | 📅 2026-09-24 - A cross-platform, fast, feature full, GPU based terminal emulator
* [Wezterm](https://github.com/wez/wezterm) ⭐ 29,011 | 🐛 1,876 | 🌐 Rust | 📅 2026-09-21 - A GPU-accelerated cross-platform terminal emulator and multiplexer written by @wez and implemented in Rust. <https://wezfurlong.org/wezterm/>
* [cool-retro-term](https://github.com/Swordfish90/cool-retro-term) ⭐ 26,438 | 🐛 569 | 🌐 QML | 📅 2026-05-31 - A good looking terminal emulator which mimics the old cathode display.
* [Upterm](https://github.com/railsware/upterm) ⚠️ Archived - **\[DEPRECATED]** A terminal emulator for the 21st century.
* [iTerm2](https://github.com/gnachman/iTerm2) ⭐ 18,092 | 🐛 73 | 🌐 Objective-C | 📅 2026-09-24 iTerm2 is a terminal emulator for Mac OS X that does amazing things.
* [electerm](https://github.com/electerm/electerm) ⭐ 15,187 | 🐛 341 | 🌐 JavaScript | 📅 2026-09-24 - Terminal / ssh / sftp / ftp / telnet / serialport / RDP / VNC / Spice client(linux, mac, win). <https://electerm.org/>
* [Mosh](https://github.com/mobile-shell/mosh) ⭐ 14,510 | 🐛 230 | 🌐 C++ | 📅 2026-03-22 - Mobile Shell.
* [Rio](https://github.com/raphamorim/rio) ⭐ 7,538 | 🐛 314 | 🌐 Rust | 📅 2026-09-20 - A hardware-accelerated GPU terminal emulator powered by WebGPU, focusing to run in desktops and browsers.
* [Extraterm](https://github.com/sedwards2009/extraterm) ⭐ 2,826 | 🐛 134 | 🌐 TypeScript | 📅 2026-06-05 - The swiss army chainsaw of terminal emulators. <https://extraterm.org>
* [tty7](https://github.com/l0ng-ai/tty7) ⭐ 1,077 | 🐛 36 | 🌐 Rust | 📅 2026-09-24 - A GPU-rendered, daemon-backed terminal in pure Rust; a persistent daemon holds the PTYs so sessions survive quitting the app (no tmux). Built on Zed's gpui and Alacritty's VT core.
* [Terminology](https://github.com/billiob/terminology) ⭐ 738 | 🐛 36 | 🌐 C | 📅 2026-09-22 - The best terminal emulator based on the Enlightenment Foundation Libraries. <https://www.enlightenment.org/about-terminology>
* [Bobcat](https://github.com/ismail-yilmaz/Bobcat) ⭐ 178 | 🐛 12 | 🌐 C++ | 📅 2026-09-06 - A modern, feature-rich, cross-platform terminal emulator built with U++ framework.
* [Yetty](https://github.com/zokrezyl/yetty) ⭐ 93 | 🐛 98 | 🌐 C | 📅 2026-09-05 - New generation terminal with remote graphics, remote GUI, rich scrolling buffer, plots, diagrams, etc
...
* [Xterm.js](https://github.com/xtermjs/xterm.js) ⭐ 21,221 | 🐛 272 | 🌐 TypeScript | 📅 2026-09-13 - A terminal for the web. <https://xtermjs.org/>
* [electerm](https://github.com/electerm/electerm) ⭐ 15,187 | 🐛 341 | 🌐 JavaScript | 📅 2026-09-24 - Terminal / ssh / sftp / ftp / telnet / serialport / RDP / VNC / Spice client(linux, mac, win). <https://electerm.org/>
...
* [Windows Terminal](https://github.com/microsoft/terminal) ⭐ 104,979 | 🐛 1,772 | 🌐 C++ | 📅 2026-09-23 -  The new Windows Terminal, and the original Windows console host - all in the same place!
* [Tabby](https://github.com/Eugeny/tabby) ⭐ 74,663 | 🐛 2,847 | 🌐 TypeScript | 📅 2026-09-24 - A terminal for a more modern age (formerly Terminus) <https://tabby.sh/>
* [Alacritty](https://github.com/jwilm/alacritty) ⭐ 65,807 | 🐛 343 | 🌐 Rust | 📅 2026-08-31 - A cross-platform, GPU-accelerated terminal emulator.
* [eDEX-UI](https://github.com/GitSquared/edex-ui) ⚠️ Archived - **\[DEPRECATED]** A cross-platform, customizable science fiction terminal emulator with advanced monitoring & touchscreen support.
* [Hyper](https://github.com/zeit/hyper) ⭐ 44,744 | 🐛 1,049 | 🌐 TypeScript | 📅 2026-08-21 - A terminal built on web technologies.
...
* [Extraterm](https://github.com/sedwards2009/extraterm) ⭐ 2,826 | 🐛 134 | 🌐 TypeScript | 📅 2026-06-05 - The swiss army chainsaw of terminal emulators. <https://extraterm.org>
* [tty7](https://github.com/l0ng-ai/tty7) ⭐ 1,077 | 🐛 36 | 🌐 Rust | 📅 2026-09-24 - A GPU-rendered, daemon-backed terminal in pure Rust; a persistent daemon holds the PTYs so sessions survive quitting the app (no tmux). Built on Zed's gpui and Alacritty's VT core.
* [Terminology](https://github.com/billiob/terminology) ⭐ 738 | 🐛 36 | 🌐 C | 📅 2026-09-22 - The best terminal emulator based on the Enlightenment Foundation Libraries [http://terminolo.gy/)](http://terminolo.gy/)
* [Bobcat](https://github.com/ismail-yilmaz/Bobcat) ⭐ 178 | 🐛 12 | 🌐 C++ | 📅 2026-09-06 - A modern, feature-rich, cross-platform terminal emulator built with U++ framework.
* [Yetty](https://github.com/zokrezyl/yetty) ⭐ 93 | 🐛 98 | 🌐 C | 📅 2026-09-05 - New generation terminal with remote graphics, remote GUI, rich scrolling buffer, plots, diagrams, etc.
...
* [PowerShell](https://github.com/PowerShell/PowerShell) ⭐ 55,508 | 🐛 1,614 | 🌐 C# | 📅 2026-09-24 - PowerShell for every system!
* [Nu Shell](https://github.com/nushell/nushell) ⭐ 40,562 | 🐛 1,434 | 🌐 Rust | 📅 2026-09-24 - A new type of shell.
* [fish](https://github.com/fish-shell/fish-shell) ⭐ 34,230 | 🐛 559 | 🌐 Rust | 📅 2026-09-23 - The user-friendly command line shell.
* [xonsh](https://github.com/xonsh/xonsh) ⭐ 9,653 | 🐛 75 | 🌐 Python | 📅 2026-09-22 - 🐚 Python-powered, cross-platform, Unix-gazing shell
...
* [ble.sh](https://github.com/akinomyoga/ble.sh) ⭐ 4,758 | 🐛 85 | 🌐 Shell | 📅 2026-09-08 - Bash Line Editor -- a full-featured line editor written in pure Bash! Syntax highlighting, auto suggestions, vim modes, etc. are available in Bash interactive sessions!
...
* [screenfetch](https://github.com/KittyKatt/screenFetch) ⭐ 4,077 | 🐛 171 | 🌐 Shell | 📅 2026-03-02 - Fetches system/theme information in terminal for Linux desktop screenshots.
...
* [tmux](https://github.com/tmux/tmux) ⭐ 49,467 | 🐛 40 | 🌐 C | 📅 2026-09-24 - tmux is a terminal multiplexer.
* [jq](https://github.com/stedolan/jq) ⭐ 35,679 | 🐛 451 | 🌐 C | 📅 2026-09-19 - Command-line JSON processor. <https://stedolan.github.io/jq/>
* [zstd](https://github.com/facebook/zstd) ⭐ 27,931 | 🐛 383 | 🌐 C | 📅 2026-09-18 - Zstandard - Fast real-time compression algorithm <http://www.zstd.net>
...
* [fastfetch](https://github.com/LinusDierheimer/fastfetch) ⭐ 24,751 | 🐛 95 | 🌐 C | 📅 2026-09-23 - Like neofetch, but much faster because written in c. Only Linux.
* [nnn](https://github.com/jarun/nnn) ⭐ 22,003 | 🐛 1 | 🌐 C | 📅 2026-09-21 - n³ The unorthodox terminal file manager.
* [ttyd](https://github.com/tsl0922/ttyd) ⭐ 12,412 | 🐛 115 | 🌐 C | 📅 2026-08-12 - Share your terminal over the web.
...
* [chafa](https://github.com/hpjansson/chafa) ⭐ 5,272 | 🐛 53 | 🌐 C | 📅 2026-09-23 - 📺🗿 Terminal graphics for the 21st century.
...
* [atop](https://github.com/Atoptool/atop) ⭐ 1,066 | 🐛 60 | 🌐 C | 📅 2026-09-23 - System and process monitor for Linux.
...
* [flameshot](https://github.com/flameshot-org/flameshot) ⭐ 30,919 | 🐛 731 | 🌐 C++ | 📅 2026-09-17 - Powerful yet simple to use screenshot software 🖥️ 📸.
* [winget](https://github.com/microsoft/winget-cli) ⭐ 26,450 | 🐛 1,312 | 🌐 C++ | 📅 2026-09-23 - Windows Package Manager CLI (aka winget).
* [watchman](https://github.com/facebook/watchman) ⭐ 13,713 | 🐛 259 | 🌐 C++ | 📅 2026-09-23 - Watches files and records, or triggers actions, when they change. <https://facebook.github.io/watchman/>
...
* [vtm](https://github.com/netxs-group/VTM) ⭐ 3,367 | 🐛 21 | 🌐 C++ | 📅 2026-09-24 - Terminal multiplexer with TUI window manager and multi-party session sharing <https://vtm.netxs.online/>
* [timg](https://github.com/hzeller/timg) ⭐ 2,762 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 - A terminal image viewer.
* [timew](https://github.com/GothenburgBitFactory/timewarrior) ⭐ 1,663 | 🐛 126 | 🌐 C++ | 📅 2026-09-19 - Commandline Time Reporting
...
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,641 | 🐛 1,053 | 🌐 Go | 📅 2026-09-24 - Simple terminal UI for git commands.
* [mkcert](https://github.com/FiloSottile/mkcert) ⭐ 59,685 | 🐛 177 | 🌐 Go | 📅 2024-08-13 - A simple zero-config tool to make locally trusted development certificates with any names you'd like. <https://mkcert.dev>
* [dive](https://github.com/wagoodman/dive) ⭐ 54,601 | 🐛 216 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [gh](https://github.com/cli/cli) ⭐ 46,391 | 🐛 1,090 | 🌐 Go | 📅 2026-09-23 - GitHub’s official command line tool
* [croc](https://github.com/schollz/croc) ⭐ 40,434 | 🐛 2 | 🌐 Go | 📅 2026-09-22 - Easily and securely send things from one computer to another 🐊 📦.
* [micro](https://github.com/zyedidia/micro) ⭐ 29,635 | 🐛 915 | 🌐 Go | 📅 2026-09-24 - A modern and intuitive terminal-based text editor. <https://micro-editor.github.io/>
* [glow](https://github.com/charmbracelet/glow) ⭐ 27,450 | 🐛 235 | 🌐 Go | 📅 2026-09-22 - Render markdown on the CLI, with pizzazz! 💅🏻
* [gum](https://github.com/charmbracelet/gum) ⭐ 24,413 | 🐛 207 | 🌐 Go | 📅 2026-09-24 - A tool for glamorous shell scripts 🎀
...
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,949 | 🐛 448 | 🌐 C | 📅 2026-09-24 - GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in \*nix systems or through your browser. <https://goaccess.io>
* [gotty](https://github.com/yudai/gotty) ⭐ 19,555 | 🐛 158 | 🌐 Go | 📅 2024-08-01 - Share your terminal as a web application.
* [browsh](https://github.com/browsh-org/browsh) ⭐ 19,062 | 🐛 241 | 🌐 JavaScript | 📅 2025-07-11 - A fully-modern text-based browser, rendering to TTY and browsers. <https://www.brow.sh/>
...
* [direnv](https://github.com/direnv/direnv) ⭐ 15,461 | 🐛 469 | 🌐 Go | 📅 2026-03-31 - unclutter your .profile. <http://direnv.net>
* [duf](https://github.com/muesli/duf) ⭐ 15,318 | 🐛 81 | 🌐 Go | 📅 2026-01-13 - Disk Usage/Free Utility.
...
* [cheat](https://github.com/cheat/cheat) ⭐ 13,467 | 🐛 34 | 🌐 Go | 📅 2026-05-19 - cheat allows you to create and view interactive cheatsheets on the command-line. It was designed to help remind \*nix system administrators of options for commands that they use frequently, but not frequently enough to remember.
...
* [screego](https://github.com/screego/server) ⭐ 10,708 | 🐛 18 | 🌐 Go | 📅 2026-08-20 - Screen sharing for developers. <https://screego.net/>
...
* [scc](https://github.com/boyter/scc) ⭐ 8,775 | 🐛 26 | 🌐 Go | 📅 2026-09-24 -  Sloc, Cloc and Code: scc is a very fast accurate code counter with complexity calculations and COCOMO estimates written in pure Go.
...
* [curlie](https://github.com/rs/curlie) ⭐ 3,727 | 🐛 27 | 🌐 Go | 📅 2025-12-07 - The power of curl, the ease of use of httpie. <https://curlie.io/>
...
* [pandoc](https://github.com/jgm/pandoc) ⭐ 46,396 | 🐛 1,041 | 🌐 Haskell | 📅 2026-09-24 - Universal markup converter <https://pandoc.org>
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 40,083 | 🐛 1,135 | 🌐 Haskell | 📅 2026-09-21 - ShellCheck, a static analysis tool for shell scripts. <https://www.shellcheck.net/>
* [bench](https://github.com/Gabriel439/bench) ⭐ 911 | 🐛 9 | 🌐 Haskell | 📅 2025-09-02 - Command-line benchmark tool.

### Node

* [tldr](https://github.com/tldr-pages/tldr) ⭐ 63,731 | 🐛 296 | 🌐 Markdown | 📅 2026-09-24 - Collaborative cheatsheets for console commands <https://tldr.sh/>
* [zx](https://github.com/google/zx) ⭐ 45,766 | 🐛 62 | 🌐 JavaScript | 📅 2026-08-14 - A tool for writing better scripts
...
* [percollate](https://github.com/danburzo/percollate) ⭐ 4,680 | 🐛 17 | 🌐 JavaScript | 📅 2025-08-29 - 🌐 → 📖 A command-line tool to turn web pages into beautifully formatted PDFs.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 193,325 | 🐛 2,675 | 🌐 Python | 📅 2026-09-16 - A youtube-dl fork with additional features and fixes
* [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,337 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19 - Command-line program to download videos from YouTube.com and other video sites <http://ytdl-org.github.io/youtube-dl/>
* [fuck](https://github.com/nvbn/thefuck) ⭐ 97,877 | 🐛 461 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command.
* [tldr](https://github.com/tldr-pages/tldr) ⭐ 63,731 | 🐛 296 | 🌐 Markdown | 📅 2026-09-24 - 📚 Simplified and community-driven man pages <https://tldr.sh>
...
* [face\_recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,776 | 🐛 832 | 🌐 Python | 📅 2026-06-25 - The world's simplest facial recognition api for Python and the command line.
* [httpie](https://github.com/jakubroztocil/httpie) ⭐ 38,576 | 🐛 337 | 🌐 Python | 📅 2024-12-17 - As easy as HTTPie /aitch-tee-tee-pie/ 🥧 Modern command line HTTP client – user-friendly curl alternative with intuitive UI, JSON support, syntax highlighting, wget-like downloads, extensions, etc. <https://httpie.org>
* [glances](https://github.com/nicolargo/glances) ⭐ 33,670 | 🐛 106 | 🌐 Python | 📅 2026-09-24 - Glances an Eye on your system. A top/htop alternative for GNU/Linux, BSD, Mac OS and Windows operating systems. <http://nicolargo.github.io/glances/>
...
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,978 | 🐛 0 | 🌐 Python | 📅 2026-09-23 - A Terminal Client for MySQL with AutoCompletion and Syntax Highlighting. <http://mycli.net>
* [datasette](https://github.com/simonw/datasette) ⭐ 11,479 | 🐛 676 | 🌐 Python | 📅 2026-09-23 - A tool for exploring and publishing data. <http://datasette.readthedocs.io/>
...
* [rg](https://github.com/BurntSushi/ripgrep) ⭐ 68,563 | 🐛 201 | 🌐 Rust | 📅 2026-08-04 - ripgrep recursively searches directories for a regex pattern.
* [bat](https://github.com/sharkdp/bat) ⭐ 60,558 | 🐛 518 | 🌐 Rust | 📅 2026-09-22 - A cat(1) clone with wings.
* [starship](https://github.com/starship/starship) ⭐ 60,032 | 🐛 1,057 | 🌐 Rust | 📅 2026-09-24 - ☄🌌️ The cross-shell prompt for astronauts. <https://starship.rs>
* [hx](https://github.com/helix-editor/helix) ⭐ 46,317 | 🐛 1,682 | 🌐 Rust | 📅 2026-09-22 - A post-modern modal text editor.
* [fd](https://github.com/sharkdp/fd) ⭐ 44,527 | 🐛 198 | 🌐 Rust | 📅 2026-09-24 - A simple, fast and user-friendly alternative to 'find'
* [z](https://github.com/ajeetdsouza/zoxide) ⭐ 39,673 | 🐛 147 | 🌐 Rust | 📅 2026-09-21 - A faster way to navigate your filesystem.
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,673 | 🐛 147 | 🌐 Rust | 📅 2026-09-21 - A smarter cd command. Supports all major shells.
* [zellij](https://github.com/zellij-org/zellij) ⭐ 35,522 | 🐛 1,942 | 🌐 Rust | 📅 2026-09-24 - A terminal workspace with batteries included. <https://zellij.dev/>
* [delta](https://github.com/dandavison/delta) ⭐ 32,320 | 🐛 449 | 🌐 Rust | 📅 2026-09-19 - A viewer for git and diff output
* [atuin](https://github.com/atuinsh/atuin) ⭐ 31,795 | 🐛 384 | 🌐 Rust | 📅 2026-09-24 - ✨ Magical shell history <https://atuin.sh/>
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,900 | 🐛 101 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool.
* [difft](https://github.com/Wilfred/difftastic) ⭐ 25,927 | 🐛 287 | 🌐 Rust | 📅 2026-09-22 - a structural diff that understands syntax 🟥🟩
* [exa](https://github.com/ogham/exa) ⭐ 24,443 | 🐛 213 | 🌐 Rust | 📅 2024-09-24 - **\[DEPRECATED]** A modern version of ‘ls’. <https://the.exa.website/>
* [coreutils](https://github.com/uutils/coreutils) ⭐ 24,170 | 🐛 1,170 | 🌐 Rust | 📅 2026-09-24 -  Cross-platform Rust rewrite of the GNU coreutils.
* [eza](https://github.com/eza-community/eza) ⭐ 23,360 | 🐛 454 | 🌐 Rust | 📅 2026-08-06 - A modern version of ‘ls’. <https://eza.rocks/>
...
* [btm](https://github.com/ClementTsang/bottom) ⭐ 14,055 | 🐛 106 | 🌐 Rust | 📅 2026-09-23 - Yet another cross-platform graphical process/system monitor. <https://clementtsang.github.io/bottom/nightly/>
* [br](https://github.com/Canop/broot) ⭐ 12,956 | 🐛 100 | 🌐 Rust | 📅 2026-09-23 - A new way to see and navigate directory trees <https://dystroy.org/broot>
* [gping](https://github.com/orf/gping) ⭐ 12,691 | 🐛 42 | 🌐 Rust | 📅 2026-09-23 - Ping, but with a graph.
* [dust](https://github.com/bootandy/dust) ⭐ 12,300 | 🐛 10 | 🌐 Rust | 📅 2026-09-16 - A more intuitive version of du in rust.
...
* [xh](https://github.com/ducaale/xh) ⭐ 8,094 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - Friendly and fast tool for sending HTTP requests
...
* [tldr](https://github.com/dbrgn/tealdeer) ⭐ 6,546 | 🐛 15 | 🌐 Rust | 📅 2026-08-25 - A very fast implementation of tldr in Rust.
* [pastel](https://github.com/sharkdp/pastel) ⭐ 6,506 | 🐛 39 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors.
* [dua](https://github.com/Byron/dua-cli) ⭐ 6,294 | 🐛 0 | 🌐 Rust | 📅 2026-09-22 - View disk space usage and delete unwanted data, fast. <https://lib.rs/crates/dua-cli>
* [procs](https://github.com/dalance/procs) ⭐ 6,181 | 🐛 36 | 🌐 Rust | 📅 2026-09-22 - A modern replacement for ps written in Rust.
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,049 | 🐛 29 | 🌐 Rust | 📅 2026-09-21 - A cross-platform network monitoring TUI with process identification and deep packet inspection.
* [amp](https://github.com/jmacdonald/amp) ⭐ 4,127 | 🐛 95 | 🌐 Rust | 📅 2026-06-10 - A complete text editor for your terminal.
* [findomain](https://github.com/Edu4rdSHL/findomain) ⭐ 3,795 | 🐛 7 | 🌐 Rust | 📅 2026-09-23 - The fastest and cross-platform subdomain enumerator, don't waste your time.
...
* [Tura](https://github.com/Tura-AI/tura) ⭐ 642 | 🐛 5 | 🌐 Rust | 📅 2026-09-13 - Tura is a local, open-source coding agent for developers who are tired of vague skill claims, token-saving extensions with no evidence, and agents that change a repository before understanding it.
...
* [nvm](https://github.com/nvm-sh/nvm) ⭐ 95,172 | 🐛 391 | 🌐 Shell | 📅 2026-09-21 - Node Version Manager - POSIX-compliant bash script to manage multiple active node.js versions.
* [nb](https://github.com/xwmx/nb) ⭐ 8,412 | 🐛 153 | 🌐 Shell | 📅 2026-08-26 - CLI plain-text note-taking, bookmarking, and archiving with encryption, filtering and search, Git-backed versioning and syncing, Pandoc-backed conversion, and more in a single portable script. <https://xwmx.github.io/nb/>
...
* [dotfiles](https://github.com/nickjj/dotfiles) ⭐ 1,336 | 🐛 1 | 🌐 Shell | 📅 2026-09-21 - Settings for various tools I use.
* [\~/.dotfiles](https://github.com/maximbaz/dotfiles) ⭐ 1,082 | 🐛 0 | 🌐 Nix | 📅 2026-09-23 - Configuration for Arch Linux, sway, kitty, kakoune, zsh and more + scripted installation guide.
* [dotfiles](https://github.com/yutkat/dotfiles) ⭐ 995 | 🐛 0 | 🌐 Lua | 📅 2026-09-24 - The best and strongest dotfiles. Editor: Neovim(coc.nvim); Shell: zsh(zinit, powerlevel10k); Terminal: tmux, alacritty; Desktop: i3-gaps/sway, rofi, dunst; OS: ArchLinux, (Ubuntu/Fedora/CentOS)
...
* [acme.sh](https://github.com/Neilpang/acme.sh) ⭐ 47,705 | 🐛 102 | 🌐 Shell | 📅 2026-09-20 - A pure Unix shell script implementing ACME client protocol. <https://acme.sh>
